...
export const categoryRecommendations: Record<QuestionCategory, string> = {
  ...
  Visibility:
    'Invest in real-time dashboards and automated status reporting. Management should not need meetings to know what is happening.',
  Automation:
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    context: 'We are looking at whether critical information flows through structured or informal channels.',
    options: [
  ...
  },
  {
    id: 'status_meetings',
    category: 'Visibility',
    label: 'Do you have regular meetings that exist primarily so management can find out what is happening?',
    context: 'If the only way to get a status update is to schedule a meeting, that is a visibility gap.',
    options: [
  ...
  },
  {
    ...
    context: 'Rework is one of the most expensive forms of waste - it consumes time that has already been spent.',
    options: [
