  ...
  return (
    <section ref={sectionRef} className="py-24 relative overflow-hidden" id="about">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" aria-hidden preserveAspectRatio="none">
        <line x1="0%" y1="20%" x2="100%" y2="60%" stroke="hsl(var(--primary))" strokeWidth="1.2" opacity="0.14" />
        <line x1="10%" y1="0%" x2="80%" y2="100%" stroke="hsl(var(--primary))" strokeWidth="1" opacity="0.12" />
        <line x1="60%" y1="0%" x2="30%" y2="100%" stroke="hsl(var(--primary))" strokeWidth="0.8" opacity="0.15" />
        <line x1="0%" y1="45%" x2="100%" y2="35%" stroke="hsl(var(--primary))" strokeWidth="0.7" opacity="0.10" />
        <line x1="85%" y1="0%" x2="95%" y2="100%" stroke="hsl(var(--primary))" strokeWidth="0.9" opacity="0.12" />
        <line x1="0%" y1="75%" x2="100%" y2="85%" stroke="hsl(var(--primary))" strokeWidth="0.8" opacity="0.13" />
        <line x1="40%" y1="0%" x2="70%" y2="100%" stroke="hsl(var(--primary))" strokeWidth="0.7" opacity="0.10" />
        <line x1="0%" y1="90%" x2="55%" y2="10%" stroke="hsl(var(--primary))" strokeWidth="1" opacity="0.12" />
        <line x1="20%" y1="100%" x2="100%" y2="15%" stroke="hsl(var(--primary))" strokeWidth="0.7" opacity="0.13" />
      </svg>
