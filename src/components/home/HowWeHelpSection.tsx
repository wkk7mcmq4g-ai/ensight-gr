...
const solutions = [
  ...
  { icon: Users, title: 'CRM & Workflows', desc: 'Manage operations, approvals, and compliance in one unified system.', hsl: 'hsl(var(--accent-cyan))' },
  { icon: BarChart3, title: 'Data & Reporting', desc: 'Real-time dashboards and reporting using Power BI and SQL.', hsl: 'hsl(var(--electric-bright))' },
  { icon: Zap, title: 'Automation & Integration', desc: 'Connect systems and automate processes using APIs and AI.', hsl: 'hsl(var(--ordinal-green))' },
];
...
const HowWeHelpSection = () => (
  <section className="max-w-[1200px] mx-auto px-6 md:px-12 py-24" id="solutions">
    ...
    <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {solutions.map((s, i) => (
        <StaggerItem key={i}>
          <div className="bg-white/75 backdrop-blur-xl border border-white/40 rounded-lg p-7 relative overflow-hidden shadow-[0_4px_24px_-4px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:shadow-md hover:border-primary/30 transition-all h-full">
