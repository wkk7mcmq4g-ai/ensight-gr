...
const steps = [
  ...
  { num: '02', title: 'Redesign', time: '1–2 WEEKS', desc: 'Fix the process before digitising it. Simplify. Remove waste. Clarify ownership. No technology yet.', color: 'text-accent-blue' },
  { num: '03', title: 'Build', time: '4–12 WEEKS', desc: "Now we implement. Custom platforms, automation, integrations — built around your redesigned processes.", color: 'text-primary' },
  { num: '04', title: 'Embed', time: '4–8 WEEKS', desc: "We stay. Monitor adoption. Manage resistance. Train your team. We don't leave until it's working.", color: 'text-secondary' },
];

const barColors = ['bg-primary', 'bg-accent-blue', 'bg-primary', 'bg-secondary'];
      ...
      {steps.map((s, i) => (
        <StaggerItem key={i}>
          <div className="bg-card border border-border rounded-lg p-7 relative overflow-hidden shadow-sm hover:-translate-y-1 hover:shadow-md transition-all h-full">
            ...
            <div className="text-xs font-semibold text-muted-foreground mb-3">{s.num}</div>
