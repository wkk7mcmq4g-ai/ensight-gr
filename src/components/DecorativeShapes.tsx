...
const DecorativeShapes = ({ variant = 'dots', className = '' }: Props) => {
  if (variant === 'minimal') {
    return (
      <div className={`absolute inset-0 pointer-events-none overflow-hidden ${className}`} aria-hidden>
        <svg viewBox="0 0 400 400" className="absolute top-0 right-0 w-[320px] h-[320px] opacity-[0.12]">
  ...
  if (variant === 'circles') {
    return (
      <div className={`absolute inset-0 pointer-events-none overflow-hidden ${className}`} aria-hidden>
        <svg viewBox="0 0 400 400" className="absolute -top-10 -right-10 w-[360px] h-[360px] opacity-[0.15]">
          {[80, 140, 200].map((r, i) => (
  ...
  if (variant === 'grid') {
    return (
      <div className={`absolute inset-0 pointer-events-none overflow-hidden ${className}`} aria-hidden>
        <svg viewBox="0 0 360 360" className="absolute top-0 right-0 w-[300px] h-[300px] opacity-[0.12]">
          {/* Grid lines */}
  ...
  return (
    <div className={`absolute inset-0 pointer-events-none overflow-hidden ${className}`} aria-hidden>
      <svg viewBox="0 0 360 300" className="absolute -top-4 right-0 w-[320px] h-[280px] opacity-[0.2]">
        {dots.map((dot, i) => (
